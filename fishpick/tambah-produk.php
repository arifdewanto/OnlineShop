...
<body>
    ...
    <div class="container">
        ...
        if(isset($_POST['submit'])){
            ...
            //menanmpubg data file yang di upload
            ...
            if(!in_array($type2, $tipe_diizinkan)){
                ...
                // jika format file tidak ada dalam tipe diziinkan
                echo '<script>alert("Format file tidak diizinkan")</script>';

            }else{
                // jika format file sesuai dengan yang ada di dalama arry tipe diizinkan
                // proses updload file sekaligus insert database
